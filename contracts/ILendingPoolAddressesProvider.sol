...
interface ILendingPoolAddressesProvider {
  ...
  event OklendTokenUpdated(address indexed newAddress);
  ...
  function setLendingPoolImpl(address pool, address weth) external;
  ...
  function getOklendToken() external view returns (address);

  function setOklendToken(address okl) external;
