 ...
 * @author OKLend
 * @notice Defines the error messages emitted by the different contracts of the OKLend protocol
...
library Errors {
  ...
  string public constant LPC_INVALID_XTOKEN_POOL_ADDRESS = '35'; // 'The liquidity of the reserve needs to be 0'
  ...
  string public constant LP_CALLER_MUST_BE_AN_XTOKEN = '63';
