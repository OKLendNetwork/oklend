...
/**
 * @title OKLend ERC20 XToken
 * @dev Implementation of the interest bearing token for the OKLend protocol
 * @author OKLend
 */
contract XToken is
    IncentivizedERC20,
    ...
    ReentrancyGuard
{
    ...
    constructor(
        ...
        rewardsToken = IERC20(ILendingPoolAddressesProvider(_addressesProvider).getOklendToken());
    }
    ...
    function burn(
        ...
        uint256 amount,
        uint256 index
    ) external override onlyLendingPool updateReward(user) {
    ...
    function mint(
        ...
        uint256 amount,
        uint256 index
    ) external override onlyLendingPool updateReward(user) returns (bool) {
    ...
    function transferOnLiquidation(
        ...
        address to,
        uint256 value
    ) external override onlyLendingPool updateReward(from) updateReward(to) {
